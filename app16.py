...
with tabs[3]:
    ...
    BUY_STATES = ["Skip/Unknown", "Eco", "Light", "Full", "Full+Save"]
    BUY_STATE_TO_ECON = {
    ...
    sigma_map = estimate_sigma(float(p0_map), int(rounds_a), int(rounds_b), float(econ_a), float(econ_b), float(chaos_boost), econ_missing=bool(econ_missing))

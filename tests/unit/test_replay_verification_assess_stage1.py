...
def test_replay_verification_assess_stage1_deterministic_and_schema_conformant() -> None:
    ...
    for key in required_keys:
        assert key in first["contract_diagnostics_required_key_type_contract"]
        ...
        assert first["contract_diagnostics_type_mismatch_counts"][key] == 0
        assert first["contract_diagnostics_type_mismatch_rates"][key] == 0.0
